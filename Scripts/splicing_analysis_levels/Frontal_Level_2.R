...
##
## Ataxia Level 2 (AtaxiaSubtype) Analysis - Frontal Cortex
##
...
## focus on Frontal Cortex Level 2 studies.
##
...
logger::log_info("Starting Analysis for Frontal Cortex Level 2.")

## Relevant Paths
if(!exists("results_path")) results_path <- here::here("results/")
project_path <- file.path(results_path, "Frontal_Level_2/")
