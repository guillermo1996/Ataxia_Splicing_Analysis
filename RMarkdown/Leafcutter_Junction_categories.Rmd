...
* `gtf_path`: path to the reference transcriptome to annotate the junctions. In this report, GENCODE v43 is employed (also tested with ENSEMBL v105).
...
annotated_path <- file.path(main_path, "variables/annotated_gencode43.rds")
