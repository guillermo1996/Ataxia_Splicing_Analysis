...
gtf_gencode_path <- file.path("/home/grocamora/RytenLab-Research/Additional_files/GENCODE/gencode.v39.annotation.gtf")
...
```{r, echo = T}
rse_jx_path <- file.path(main_path, "variables/rse_jx_gencode39.rds")
